...
public class Parameter {
  ...
  public static final String resourcesdir =
      userdir + sep + "src" + sep + "main" + sep + "resources" + sep;
  ...
  public static final String buttonArrow = imagesdir + "button-arrow.png";
  ...
  public static final String buttonClick03Sound =
      soundsdir + "zapsplat_multimedia_button_click_fast_short_003.mp3";
  public static final String buttonClick04Sound =
      soundsdir + "zapsplat_multimedia_button_click_fast_short_004.mp3";

  public static final String audioSpeakerIcon = imagesdir + "audio-speaker.png";
  public static final String audioSpeakerMuteIcon = imagesdir + "audio-speaker-mute.png";
  ...
  public static final String[] allColors =
      new String[] {"#c1272d", "#0071bc", "#159e13", "#d1bc04", "#f28a3a", "#c73af2"};
  ...
  public static final String[] allAvatars = new String[] {"earrings-girl.png", "bruntette-boy.png",
      "blonde-boy.png", "ginger-girl.png", "hat-boy.png", "mustache-man.png"};
