...
public class SetTerritories {
	...
	public static void createContinents(HashMap<Continent, ArrayList<CountryName>> continents,
		...
		continents.put(Continent.Australia,
				(ArrayList<CountryName>) territories.entrySet().stream()
						.filter(o -> o.getValue().getContinent().equals(Continent.Australia)).map(Map.Entry::getKey)
		...
		continents.put(Continent.Africa,
				(ArrayList<CountryName>) territories.entrySet().stream()
						.filter(o -> o.getValue().getContinent().equals(Continent.Africa)).map(Map.Entry::getKey)
						.collect(Collectors.toList()));
		continents.put(Continent.NorthAmerica,
				(ArrayList<CountryName>) territories.entrySet().stream()
						.filter(o -> o.getValue().getContinent().equals(Continent.NorthAmerica)).map(Map.Entry::getKey)
						.collect(Collectors.toList()));
		continents.put(Continent.SouthAmerica,
				(ArrayList<CountryName>) territories.entrySet().stream()
						.filter(o -> o.getValue().getContinent().equals(Continent.SouthAmerica)).map(Map.Entry::getKey)
						.collect(Collectors.toList()));

		continents.put(Continent.Europe,
				(ArrayList<CountryName>) territories.entrySet().stream()
						.filter(o -> o.getValue().getContinent().equals(Continent.Europe)).map(Map.Entry::getKey)
						.collect(Collectors.toList()));
	...
	public static void setNeighboringCountrys(HashMap<CountryName, Territory> territories) {
		...
		territories.get(CountryName.Siberia).setNeighboringTerritories(
				new ArrayList<>(Arrays.asList(territories.get(CountryName.Ural), territories.get(CountryName.China),
		...
		territories.get(CountryName.Kamchatka)
				.setNeighboringTerritories(new ArrayList<>(Arrays.asList(territories.get(CountryName.Yakutsk),
		...
		territories.get(CountryName.Indonesia)
				.setNeighboringTerritories(new ArrayList<>(Arrays.asList(territories.get(CountryName.Siam),
						territories.get(CountryName.NewGuinea), territories.get(CountryName.WesternAustralia))));
