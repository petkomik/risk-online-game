...
/**
 * Modells the State of game. All information about the player, territories are
 * saved. Consists mostly of getter and setter methods.
 *
 * @author pmikov
 */
...
public class GameState implements Serializable {
    ...
    /**
     * Constructor for the class. Initializes all the variables and sets values to
     * default for beginning of the game.
     *
	...
	this.getPlayerTroopsLeft().replace(idPlayer, this.getPlayerTroopsLeft().get(idPlayer) + numberOfTroops);
    }
	...
	if (this.playerTroopsLeft.get(idPlayer) >= numberOfTroops) {
	    this.getPlayerTroopsLeft().put(idPlayer, this.getPlayerTroopsLeft().get(idPlayer) - numberOfTroops);
	} else {
