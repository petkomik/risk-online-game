...
/**
 * The MessageGUIsetCurrentPlayer class represents a message used to update the current player in the game GUI.
 * It includes the game state, the player ID, the number of troops left for the player, and the lobby information.
 * 
 * author dignatov
 */
public class MessageGUIsetCurrentPlayer extends Message {
  ...
  private Lobby lobby;
	...
	/**
	 * Constructs a MessageGUIsetCurrentPlayer object with the specified game state, player ID, number of troops left, and lobby information.
	 *
