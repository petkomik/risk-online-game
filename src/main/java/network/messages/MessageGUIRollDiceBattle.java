 ...
 * dice in a battle in the game GUI. It includes the game state, the values of the attacker's dice,
 * the values of the defender's dice, the number of troops in the attacking territory, the number of
...
public class MessageGUIRollDiceBattle extends Message {
  ...
  /**
   * Constructs a MessageGUIRollDiceBattle object with the specified game state, attacker's dice
