...
public class MultiplayerJoinWindowController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		fontSize = 0.137 * Math.sqrt(Math.pow(ipAddressLabel.getPrefWidth(), 2.0)+Math.pow(ipAddressLabel.getPrefHeight(), 2.0));
	...
	/**
	 * The method handles the event, when the user presses on the "Join Server" button
	 * @param e
	 * @throws IOException
	 */
