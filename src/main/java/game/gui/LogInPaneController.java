...
/**
 * This is the class for the Log In GUI window. Handles profile log in on the GUI side.
 *
 * @author mikov
 *
 */
  ...
  public void buttonEvents() {
    logInButton.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        boolean loginSuccess = AppController.logIntoProfile(usernameField.getText().trim(),
