...
public class GamePaneController implements Initializable {
	...
	cancelHintButton.hoverProperty().addListener((ChangeListener<Boolean>) (observable, oldValue, newValue) -> {
	    if (newValue) {
		cancelHintButton.setStyle("-fx-background-color: #ac7339; " + "-fx-background-radius: 15px; ");
	    } else {
		cancelHintButton.setStyle("-fx-background-color: #cc9966; -fx-background-radius: 15px;");
	    }
	});
